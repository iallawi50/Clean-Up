        ...
        <div class="bg-white text-blue-500 p-4">
            <form action="{{ Route('ads.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col">
                    ...
                    <input name="title" type="text" class="rounded mt-2" value="{{ old('title') }}">
                    @error('title')
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <input name="body" type="text" class="rounded mt-2" value="{{ old('body') }}">
                    @error('body')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row justify-end" style="user-select: none">
                        ...
                        <label for="category-1"
                            ...
                            <input id="category-1" type="radio" value="غسيل سيارات"
                                ...
                                name="category" {{ old('category') == 'غسيل سيارات' ? 'checked' : '' }}>
                        ...
                        <label for="category-2"
                            ...
                            <input id="category-2" type="radio" value="غسيل سجادات"
                                class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-200"
                                name="category" {{ old('category') == 'غسيل سجادات' ? 'checked' : '' }}>
                        </label>
                        ...
                        <label for="category-3"
                            ...
                            <input id="category-3" type="radio" value="غسيل منازل"
                                class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-200"
                                name="category" {{ old('category') == 'غسيل منازل' ? 'checked' : '' }}>
                        </label>
                ...
                <div class="text-left mt-5">
                    <button class="text-left px-5 custom-primary-button">نشر</button>
                </div>
